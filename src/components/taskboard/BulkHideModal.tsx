      ...
      <div className="w-full max-w-sm rounded-2xl border border-slate-700 bg-slate-900 p-5 shadow-2xl">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-base font-bold text-white">
            {t({
              ...
              ja: "非表示にする状態を選択",
              zh: "选择要隐藏的状态", es: "Selecciona estados para ocultar"
            })}
          </h2>
          <button
            onClick={onClose}
        ...
        <p className="mb-3 text-xs leading-relaxed text-slate-400">
          {t({
            ...
            zh: "一次性隐藏所选完成/待处理/已取消状态的任务。", es: "Oculta todas las tareas en los estados completado/pendiente/cancelado de una vez."
          })}
        </p>
        ...
        <div className="mt-4 flex items-center justify-end gap-2">
          ...
          >
            {t({ ko: "숨김 적용", en: "Apply hide", ja: "非表示適用", zh: "应用隐藏", es: "Aplicar ocultación" })} ({hideTargetCount})
          </button>
        </div>
      </div>
    </div>
