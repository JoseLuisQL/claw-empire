  ...
  return (
    <>
      ...
      <div className="text-xs text-slate-500 px-1">
        {filteredLength}
        {t({ ko: "개 스킬 표시중", en: " skills shown", ja: "件のスキルを表示中", zh: " 个技能已显示", es: " habilidades mostradas" })}
        {search && ` · "${search}" ${t({ ko: "검색 결과", en: "search results", ja: "検索結果", zh: "搜索结果", es: "resultados de búsqueda" })}`}
      </div>
    </>
  );
}
