...
- Scope: Agent token optimization — auto-generated project context, recent changes sharing, CLAUDE.md auto-generation, MVP code review policy
...
- Bilingual (EN/KO) code review policy injected into all agent prompts:
